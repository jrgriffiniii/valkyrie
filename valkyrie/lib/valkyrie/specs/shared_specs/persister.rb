...
RSpec.shared_examples 'a Valkyrie::Persister' do |*flags|
  ...
  it "can support deep nesting of resources" do
    ...
    book = resource_class.new(title: "Sub-nested", author: RDF::URI("http://test.com"))
    ...
    expect(reloaded.nested_resource.first.nested_resource.first.author).to eq [RDF::URI("http://test.com")]
  end
