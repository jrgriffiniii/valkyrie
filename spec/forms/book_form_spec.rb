...
RSpec.describe BookForm do
  ...
  describe "#append_id" do
    it "coerces it to a Sleipnir::ID" do
      form.validate(append_id: "Test")
      expect(form.append_id).to be_kind_of Sleipnir::ID
    end
  end

  describe "#member_ids" do
    it "coerces an array into Sleipnir::IDs" do
      form.validate(member_ids: ["1", "2"])
      form.member_ids.each do |id|
        expect(id).to be_kind_of Sleipnir::ID
      end
    end
  end
  ...
  describe "#thumbnail_id" do
    it "coerces it to a Sleipnir::ID" do
      ...
      expect(form.thumbnail_id).to be_kind_of Sleipnir::ID
    end
  end
  ...
  describe "#start_canvas" do
    it "coerces it to a Sleipnir::ID" do
      ...
      expect(form.start_canvas).to be_kind_of Sleipnir::ID
    end
  end
end
