...
module Sleipnir::Persistence::Solr
  class Mapper
    ...
    def created_at
      (object.created_at || Time.current).utc.iso8601
    end
    ...
    private
      ...
      class SolrMapperValue < ::Sleipnir::ValueMapper
      end

      class NestedObjectValue < ::Sleipnir::ValueMapper
      ...
      class NilPropertyValue < ::Sleipnir::ValueMapper
        SolrMapperValue.register(self)
        def self.handles?(value)
      ...
      class IDPropertyValue < ::Sleipnir::ValueMapper
        SolrMapperValue.register(self)
        def self.handles?(value)
          value.is_a?(Property) && value.value.is_a?(::Sleipnir::ID)
        end
      ...
      class URIPropertyValue < ::Sleipnir::ValueMapper
        SolrMapperValue.register(self)
        def self.handles?(value)
      ...
      class IntegerPropertyValue < ::Sleipnir::ValueMapper
        SolrMapperValue.register(self)
        def self.handles?(value)
      ...
      class SharedStringPropertyValue < ::Sleipnir::ValueMapper
        SolrMapperValue.register(self)
        def self.handles?(value)
      ...
      class StringPropertyValue < ::Sleipnir::ValueMapper
        SolrMapperValue.register(self)
        def self.handles?(value)
      ...
      class LiteralPropertyValue < ::Sleipnir::ValueMapper
        SolrMapperValue.register(self)
        def self.handles?(value)
