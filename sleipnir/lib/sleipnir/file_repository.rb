  ...
  class FileRepository
    ...
    class DiskRepository
      ...
      def upload(file:, model: nil)
        ...
        find_by(id: Sleipnir::ID.new("diskrepository://#{new_path}"))
      end
      ...
      def find_by(id:)
        ...
        File.new(id: Sleipnir::ID.new(id.to_s), io: ::File.open(file_path(id)))
      end
    end
    ...
    class Memory
      ...
      def upload(file:, model: nil)
        identifier = Sleipnir::ID.new("memory://#{model.id}")
    ...
    class File < Dry::Struct
      ...
      attribute :io, Sleipnir::Types::Any
