...
RSpec.shared_examples 'a Sleipnir query provider' do
  before do
    ...
    class SecondResource < Sleipnir::Model
      attribute :id, Sleipnir::Types::ID.optional
    end
  end
  after do
  ...
  describe ".find_by" do
    ...
    it "returns a Sleipnir::Persistence::ObjectNotFoundError for a non-found ID" do
      expect { query_service.find_by(id: "123123123") }.to raise_error ::Sleipnir::Persistence::ObjectNotFoundError
    end
  end
